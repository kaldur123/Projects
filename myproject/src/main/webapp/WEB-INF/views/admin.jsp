    ...
    <menu class="menu">
        ...
        <sec:authorize access="isAuthenticated()">
            <sec:authorize access="hasRole('ADMIN')">
                <a href="/admin" class="menuLink button">My Cabinet</a>
            </sec:authorize>
...
<main class="main">
    <section class="section">
        ...
        <h3>Hello, ${adminProfile.fullName}</h3>
                <a href="/admin/info" class="btn btn-info btn-lg btn3d"><span class="glyphicon glyphicon-question-sign"></span>Info</a><br>
                <a href="/admin/edit" class="btn btn-magick btn-lg btn3d"><span class="glyphicon"></span>Edit</a><br>
                <a href="/admin/add-dino" class="btn btn-success btn-lg btn3d"><span class="glyphicon"></span>Add dino</a><br>
                <a href="/admin/users" class="btn btn-primary btn-lg btn3d"><span class="glyphicon"></span>Show all users</a>
