...
@EnableJpaRepositories(basePackages = "ua.logos.spring.repository")
@ComponentScan(basePackages = {"ua.logos.spring.repository","ua.logos.spring.service"})
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManagerFactory() throws PropertyVetoException {
        ...
        emf.setPackagesToScan(new String[] {"ua.logos.spring.entity"}); // Entity package
        ...
        jpaProperties.put("hibernate.enable_lazy_load_no_trans", "true"); // Fix - no session
