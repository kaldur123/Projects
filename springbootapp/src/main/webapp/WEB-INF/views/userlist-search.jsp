        ...
        <div class="panel panel-primary filterable">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${userList}" var="user">
                    <tr>
                        ...
                        <td>${user.salary}</td>
                        <td>
                            <form:form action="/users/search/${user.id}" method="post" enctype="multipart/form-data" modelAttribute="${user.image}">
                                <input type="file" name="file" class="btn btn-large"/>
                                <button type="submit">Load</button>
                            </form:form>
                        </td>
                        <td><a href="/user/info/${user.id}" class="btn btn-default">Info</a></td>
                    </tr>
                </c:forEach>
            </table>
            <div class="text-center">
                <ul class="pagination">
                    ...
                    <%--<c:forEach var="j" begin="${endIndex+1}" end="${endIndex + 3}">--%>
                    <%--<c:url var="nextPage" value="/users?page=${j}"/>--%>
                    <%--<li><a href="${nextPage}">${j+1}</a></li>--%>
                    <%--</c:forEach>--%>
